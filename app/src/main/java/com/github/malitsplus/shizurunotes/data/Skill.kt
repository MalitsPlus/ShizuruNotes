...
class Skill(
    ...
    enum class SkillClass(val value: String) {
        ...
        fun description(): String {
            return when (this) {
                UB ->
                    I18N.getString(R.string.union_burst)
                UB_EVO ->
                    I18N.getString(R.string.union_burst_evo)
                MAIN1 ->
                    I18N.getString(R.string.main_skill_1)
                MAIN2 ->
                    I18N.getString(R.string.main_skill_2)
                MAIN3 ->
                    I18N.getString(R.string.main_skill_3)
                MAIN4 ->
                    I18N.getString(R.string.main_skill_4)
                MAIN5 ->
                    I18N.getString(R.string.main_skill_5)
                MAIN6 ->
                    I18N.getString(R.string.main_skill_6)
                MAIN7 ->
                    I18N.getString(R.string.main_skill_7)
                MAIN8 ->
                    I18N.getString(R.string.main_skill_8)
                MAIN9 ->
                    I18N.getString(R.string.main_skill_9)
                MAIN10 ->
                    I18N.getString(R.string.main_skill_10)
                MAIN1_EVO ->
                    I18N.getString(R.string.main_skill_1_evo)
                MAIN2_EVO ->
                    I18N.getString(R.string.main_skill_2_evo)
                SP1 ->
                    I18N.getString(R.string.sp_skill_1)
                SP2 ->
                    I18N.getString(R.string.sp_skill_2)
                SP3 ->
                    I18N.getString(R.string.sp_skill_3)
                SP4 ->
                    I18N.getString(R.string.sp_skill_4)
                SP5 ->
                    I18N.getString(R.string.sp_skill_5)
                EX1 ->
                    I18N.getString(R.string.ex_skill_1)
                EX2 ->
                    I18N.getString(R.string.ex_skill_2)
                EX3 ->
                    I18N.getString(R.string.ex_skill_3)
                EX4 ->
                    I18N.getString(R.string.ex_skill_4)
                EX5 ->
                    I18N.getString(R.string.ex_skill_5)
                EX1_EVO ->
                    I18N.getString(R.string.ex_skill_1_evo)
                EX2_EVO ->
                    I18N.getString(R.string.ex_skill_2_evo)
                EX3_EVO ->
                    I18N.getString(R.string.ex_skill_3_evo)
                EX4_EVO ->
                    I18N.getString(R.string.ex_skill_4_evo)
                EX5_EVO ->
                    I18N.getString(R.string.ex_skill_5_evo)
                else ->
                    I18N.getString(R.string.unknown)
            }
        }
