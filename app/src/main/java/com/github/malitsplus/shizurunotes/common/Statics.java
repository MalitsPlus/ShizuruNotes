...
public class Statics {
    ...
    public final static String DB_URL = "https://raw.githubusercontent.com/esterTion/redive_master_db_diff/master/";
    ...
    public final static String TABLE_UNIT_DATA = DB_URL + "/unit_data.sql";
}
